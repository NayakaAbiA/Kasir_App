...
@if(Auth::guard('petugas')->check() && Auth::guard('petugas')->user()->hasRole('petugas'))
    @include('layouts.sidebarpetugas')  <!-- Sidebar untuk petugas -->
@elseif(Auth::guard('pimpinan')->check() && Auth::guard('pimpinan')->user()->hasRole('pimpinan'))
    @include('layouts.sidebarpimpinan')  <!-- Sidebar untuk pemimpin -->
@else
    @include('layouts.sidebar')  <!-- Sidebar default untuk role lainnya -->
@endif
